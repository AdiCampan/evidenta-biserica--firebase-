...
function Persoana() {
  ...
  const saveData = () => {
    ...
    const spouse = currentData.relations.find(person => person.type === 'wife' || person.type === 'husband');
    const children = currentData.relations.filter(person => person.type === 'child');
